...
from MLP_2D_3D_lifting.abs_pose_lifting_network import RelativeDistancePredictionNetwork, RootDistancePredictionNetwork, CorrectionNetwork, IntegratedPoseEstimationModel
...
# Change the config
cfg.MODEL.WEIGHTS = "/workspace/data/model_output/twoD_pose_estimator/workspace_pre__augs_0.0001_2023-12-20_14-26-53/model_final.pth"
...
if inference:
    ...
    absolute_3d_joint_estimation_network.load_state_dict(torch.load("/workspace/data/model_weights/MLP_2D_3D_lifting/model_weights-240111_122503-finetuned_wd.pth", map_location=DEVICE))
...
PJPE_arr = np.array(PJPE_list, dtype=np.float32)
