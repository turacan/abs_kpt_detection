...
if __name__ == "__main__":
    ...
    train_model = False
    if pre_trained:
        pre_trained_weights = "/workspace/repos/MLP_2D_3D_lifting/weights/model_weights-240111_122503-finetuned_wd.pth" #/workspace/repos/MLP/weights/model_weights-240111_121437-wd.pth'
