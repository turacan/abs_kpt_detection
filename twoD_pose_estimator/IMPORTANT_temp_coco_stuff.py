# this file is used to adjust the detectron2 COCOEvaluator, as it is necesarry that augmentations are used, which needs to be implemented 
# in file keypoint_trainer.py called by function build_evaluator of class CustomTrainer(DefaultTrainer) 
...
# File "/workspace/detectron2/detectron2/data/dataset_mapper.py", line 154, in __call__
#     image = utils.read_image(dataset_dict["file_name"], format=self.image_format)
#   File "/workspace/detectron2/detectron2/data/detection_utils.py", line 181, in read_image
#     image = Image.open(f)
